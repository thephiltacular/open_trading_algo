...
def fixed_fractional_position_size(account_value: float, risk_per_trade: float, stop_distance: float) -> float:
...
def portfolio_hedge_signal(df: pd.DataFrame, market_index: pd.Series, threshold: float = -0.03) -> pd.Series:
